...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=0.9\textwidth]{images/pictures/testLinearRegression/LinearRegression_selectedpoints.png}
