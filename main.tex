...
Il est alors possible de calculer l'énergie de calibration pour un second jeu de données. La Fig. \ref{ecaliboveretrueKNNGC} nous montre que la calibration est bonne car en moyenne $E_{\rm calib}/E_{\rm true}$ est proche de 1 (sauf à bas et haut $/E_{\rm true}$).
