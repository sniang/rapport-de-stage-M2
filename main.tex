...
\begin{itemize}
    ...
    \item $\mu^+,\mu^-$ :
        ...
        \end{itemize}
\end{itemize}
\`A noter que dans notre étude seuls les hadrons chargés nous intéressent. \\
Toutes ces informations vont permettre par la suite de reconstruire toute la décomposition qui s'effectue dans le détecteur, cette opération s'appelle le \textit{Particle Flow (PF)}.\\
