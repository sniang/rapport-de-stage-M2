...
- annonce decouverte Higgs 2012 par ATLAS \cite{HiggsAtlas} et CMS\cite{HiggsCMS}. \\
...
Pour suivre le flux de particule, le détecteur CMS \cite{CMS} dispose :
\begin{itemize}
