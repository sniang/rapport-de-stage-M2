...
for ecal != 0 : \\
        ecalib = 1.34578479311 ecal + 0.987111240421 ecal + 8.27380815395\\
%\begin{figure}[!h]
%\begin{center}
...
- trouver les plus proches voisin sckitlearn \cite{scikitKNN}\\
