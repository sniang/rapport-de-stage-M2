...
Ainsi, les particules chargées seront donc d'abord suivies dans le traceur, et interagiront avec le calorimètre électromagnétique et les hadrons non chargés ne seront détectés potentiellement dans le ECAL constitué d'un cristal de tungstate de plomb et obligatoirement dans le HCAL, composé de plusieurs couches d'amortisseurs en laiton et de carreaux scintillateurs en plastique, et qui arrête toutes les particules sauf les muons qui seront suivis justement par le système de suivis des muons (cf Fig. \ref{schemaCMS}).
