...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{images/pictures/testLinearRegression/LinearRegression_selectedpoints.png}
