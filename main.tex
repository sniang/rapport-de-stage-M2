...
fontionnement de ECAL \cite{ECAL1,ECAL2}
fonctionnement de HCAL \cite{HCAL}
...
Une technique classique de calibration consiste à déterminer l'énergie calibrée par une fonction linéaire de l'énergie lue dans le ECAL et de celle lue dans le HCAL. Nous reviendrons en détail sur cette méthode dans la section \ref{LR}.\\
