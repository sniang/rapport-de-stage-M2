...
La Fig. \ref{limite} montre en particulier que dans le plan 

\begin{figure}[!t]
    \begin{center}
        \includegraphics[width=\textwidth]{images/pictures/explain/limit_arrow.png}
        \caption{On place une limite à  $E_{\rm ecal}+E_{\rm hcal} = 150$. À gauche : en bleu la zone où nous pouvons calculer les énergies calibrée, en vert, là où nous ne le pouvons pas. En haut à droite : la même choses pour les particules qui ont $E_{\rm ecal} = 0$. En bas à droit : avec les points dans le cône.}
        \label{limite}
    \end{center}
\end{figure}
