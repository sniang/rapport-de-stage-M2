...
\begin{itemize}
	...
	\item on effectue une moyenne pondérée une moyenne pondérée des $E_{\rm true}^i$ de ces plus proches voisins $\rightarrow E_{\rm calib}^0$ : l'énergie calibrée 
\end{itemize}
...
Nous constatons que partout l'énergie de calibration est sur-estimée et particulièrement à bas $E_{\rm ecal}$ et $E_{\rm hcal}$ si l'on regarde la Fig. \ref{ecaliboveretrueKNN_ecal_hcal}.
