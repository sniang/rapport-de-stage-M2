...
- paramètres : \\
$\rm{lim} = 150, n_{\rm neighbors, Ecal = 0} = 2000, n_{\rm neighbors, Ecal \neq 0} = 250, \rm{lim} = 150, \sigma  = 5$\\
weights = 'gaussian'\\
...
%\begin{figure}[!h]
%\begin{center}
%\includegraphics[width=\textwidth]{images/pictures/testKNNGC/KNNGaussianCleaning_chi2_calib.eps}
